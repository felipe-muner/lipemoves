// Compact country list for the phone-number field. Flag emoji is derived from
// the ISO 3166-1 alpha-2 code, so we only store [name, iso2, dial].
...
/** Turn "TH" into 🇹🇭 via regional-indicator code points. */
...
export const DEFAULT_COUNTRY =
  COUNTRIES.find((c) => c.iso2 === "TH") ?? COUNTRIES[0]
