...
export const moveBetter: EbookContent = {
  ...
  chapters: [
    {
      ...
      lead: "I'm Felipe. Until I was 28 I lived the typical western loop: 8 hours of sleep, 8 hours at the office, 3 meals a day, an hour at the gym. Like most guys, I only trained my upper body. My legs were weak, my mobility was awful, and my body looked fine in the mirror but couldn't actually do much in real life.",
      body: "In 2018 I left my country to travel the world, and while I was trying to enjoy the trip, my body was falling apart. Stiff, tight, sore in places it shouldn't be. During covid I got stuck in Vietnam, and for the first time I became really consistent with yoga, practicing every day with locals and learning from Indian masters.\n\nSo I started rebuilding from the ground up, and the wild part is that all of it happened after 30. Mobility came first, then flexibility, then stability and balance. Only after all of that did I add muscle, and this time it actually works. I sit on the floor without thinking about it. I lift, I twist, I run, I fall and get back up. If I could pull this off in my thirties, you can too.\n\nThat's all this guide is. Not a diet, not some hack. It's the exact stuff I do, after years of trying things, failing, and adjusting. You can read it in about 20 minutes and then apply it for the rest of your life. Share it with the people you care about. And if you want me to walk this path with you, I'll be waiting at the end of the book.",
    },
    {
      title: "The formula",
    ...
    {
      title: "Breath + eyes",
      dek: "First the breath, then the eyes, then the movement.",
      lead: "Breath and gaze always come first. The movement follows. And as you move, squeeze the muscle with intention — that's what integrates the body and defines the fibers. Get those three right and everything else falls into place: strength, balance, precision.",
      body: "Set the breath, then fix your eyes on a single point: the kettlebell as it swings, the horizon during a get-up, the hand that moves during a clean. The eyes anchor the nervous system and tell the body it's safe, focused, in control. That's where balance comes from.\n\nSoft gaze, hard intention. No darting around, no checking the mirror, no glancing at the phone. When the eyes settle, the breath settles, and the movement becomes precise.",
    },
    {
      title: "Mindfulness in motion",
      dek: "To train is to meditate.",
      lead: "When I train, I train. Outdoors when possible, sunrise if I can — no phone, no music, no AC or fan, no talking, no sitting, no rush. Live each movement, fully.",
  ...
  chapterPhoto: [4, 5, 17, 6, 15, 14, 11, 18, 10],
