...
export const moveBetterPt: EbookContent = {
  ...
  offers: [
    ...
    {
      eyebrow: "Viagem · Na estrada",
      title: "Viaja sem se perder",
      text: "8 anos na estrada, rotina nunca quebrada. Eu monto sua próxima viagem em volta de movimento, alimentação e descanso — onde treinar, o que comer em cada país, como dormir entre fusos. Uma prática diária simples que cabe em hotel, praia, selva, aeroporto.",
  ...
  closingText:
    "Esse guia é um resumo do que eu faço. Não é orientação médica e não é promessa. É um convite pra você experimentar, escutar seu corpo e construir sua própria fórmula.",
